...
/// Routes rows to the correct RotationWriter based on partition and bucket
/// IDs. Owns a collection of RotationWriters and handles the fan-out of
...
class PartitionWriter {
 public:
  ...
  const std::vector<std::unique_ptr<RotationWriter>>& writers() const {
    return writers_;
  }
